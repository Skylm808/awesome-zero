...
- [go-zero-box](https://github.com/prf16/go-zero-box) - go-zero-box 是一套基于 go-zero 的实战级工程模板，开箱即用，包含 api、scheduler、queue、script 服务，如果你正在使用 go-zero 构建真实业务系统，并希望项目从第一天起就具备良好的结构、清晰的边界和可维护性，那么 go-zero-box 可以帮助你少走大量工程弯路。
- [go-zero-box-rpc](https://github.com/prf16/go-zero-box-rpc) - go-zero-box-rpc 是 go-zero-box 体系中专门面向 rpc 服务的工程模板方案, 同样 go-zero-box 拥有的能力依然在 rpc 服务内置了。如果你正在使用 go-zero 构建多服务架构，并希望 rpc 服务：结构清晰、职责单一、易于维护和扩展，那么 go-zero-box-rpc 将非常适合你。
